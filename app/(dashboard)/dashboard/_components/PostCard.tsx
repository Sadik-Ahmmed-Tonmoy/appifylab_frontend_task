          ...
          <div className="_comment_main" key={comment.id}>
            <div className="_comment_image">
              <a href="profile.html" className="_comment_image_link">
                <img src={comment.authorImg} alt="" className="_comment_img1" />
              </a>
            </div>
                ...
                <div className="_total_reactions">
                  <div className="_total_react">
                    ...
                    <span className="_reaction_heart">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-heart">
              ...
              <div className="_feed_inner_comment_box">
                <form className="_feed_inner_comment_box_form" onSubmit={(e) => e.preventDefault()}>
                  <div className="_feed_inner_comment_box_content">
                    ...
                    <div className="_feed_inner_comment_box_content_txt">
                      <textarea className="form-control _comment_textarea" placeholder="Write a comment" id="floatingTextarea2" defaultValue=""></textarea>
                    </div>
                  </div>
                  <div className="_feed_inner_comment_box_icon">
