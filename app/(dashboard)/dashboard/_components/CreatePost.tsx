      ...
      <div className="_feed_inner_text_area_box">
        ...
        <div className="form-floating _feed_inner_text_area_box_form ">
          <textarea
            ...
            placeholder={loading ? "" : "Leave a comment here"}
            id="floatingTextarea"
            value={text}
          ...
          ></textarea>
          {!loading && (
            <label className="_feed_textarea_label !flex justify-center items-center gap-2" htmlFor="floatingTextarea">Write something ...
