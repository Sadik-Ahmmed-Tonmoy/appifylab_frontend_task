    ...
    <div className="_feed_inner_text_area  _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
      <div className="_feed_inner_text_area_box">
        <div className="_feed_inner_text_area_box_image">
          <img src={userAvatar} alt="Image" className="_txt_img" />
        </div>
      ...
      {imagePreview && (
        <div style={{ position: "relative", marginTop: "0.75rem", display: "inline-block" }}>
          <img
            src={imagePreview}
            alt="Preview"
            style={{ maxHeight: "180px", maxWidth: "100%", borderRadius: "8px", display: "block" }}
          />
          <button
            type="button"
        ...
        <div className="_feed_inner_text_area_item">
          ...
          <div className="_feed_inner_text_area_bottom_photo _feed_common">
            ...
            >
              ...
              {imageFile ? `📷 ${imageFile.name.substring(0, 10)}…` : "Photo"}
            </button>
          </div>
          {/* Video */}
          ...
          {/* Event — repurposed as visibility toggle */}
          ...
          <div className="_feed_inner_text_area_item">
            ...
            <div className="_feed_inner_text_area_bottom_event _feed_common">
              ...
              >
                <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img">
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
                    <path fill="#666" d="M14.371 2c.32 0 .585.262.627.603l.005.095v.788c2.598.195 4.188 2.033 4.18 5v8.488c0 3.145-1.786 5.026-4.656 5.026H7.395C4.53 22 2.74 20.087 2.74 16.904V8.486c0-2.966 1.596-4.804 4.187-5v-.788c0-.386.283-.698.633-.698zm3.546 8.283H4.004l.001 6.621c0 2.325 1.137 3.616 3.183 3.697l.207.004h7.132c2.184 0 3.39-1.271 3.39-3.63v-6.692z" />
                  </svg>
                </span>
              </button>
            </div>
