          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
              <li className="nav-item _header_nav_item">
                <Link className="nav-link _header_nav_link_active _header_nav_link" aria-current="page" href="/dashboard">
              ...
              <li className="nav-item _header_nav_item">
                <span id="_notify_btn" ref={notifyRef} className="nav-link _header_nav_link _header_notify_btn" onClick={() => setNotifyOpen(!notifyOpen)}>
                  ...
                  <div id="_notify_drop" className={`_notification_dropdown ${notifyOpen ? "show" : ""}`} onClick={(e) => e.stopPropagation()}>
                    <div className="_notifications_content">
                      ...
                      <div className="_notification_box_right">
                        <button type="button" className="_notification_box_right_link" onClick={() => setNotifySettingsOpen(!notifySettingsOpen)}>
            ...
            <div className="_header_nav_profile" ref={profileRef}>
              ...
              <div id="_prfoile_drop" className={`_nav_profile_dropdown _profile_dropdown ${profileOpen ? "show" : ""}`}>
                ...
                <ul className="_nav_dropdown_list">
                  ...
                  <li className="_nav_dropdown_list_item">
                    <a href="#0" className="_nav_dropdown_link" onClick={(e) => { e.preventDefault(); signOut({ callbackUrl: "/auth/login" }); }}>
                      <div className="_nav_drop_info">
                        <span>
                ...
                <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                  <div className="_header_mobile_menu_top_inner">
                    <div className="_header_mobile_menu_logo">
                      <Link href="/dashboard" className="_mobile_logo_link">
                        <img src="/assets/images/logo.svg" alt="Image" className="_nav_logo" />
                      </Link>
                    </div>
              ...
              <div className="col-xl-12 col-lg-12 col-md-12">
                <ul className="_mobile_navigation_bottom_list">
                  <li className="_mobile_navigation_bottom_item">
                    <Link href="/dashboard" className="_mobile_navigation_bottom_link _mobile_navigation_bottom_link_active">
