        ...
        <div className="container _custom_container">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div className="_notifications_content">
                      ...
                      <div className="_notification_box_right">
                        <button
                          ...
                          onClick={() =>
                            setNotifySettingsOpen(!notifySettingsOpen)
                          }
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div
                          className={`_notifications_drop_right ${notifySettingsOpen ? "show" : ""}`}
                        >
            ...
            <div className="_header_nav_profile" ref={profileRef}>
              <div className="flex items-center" onClick={() => setProfileOpen(!profileOpen)}>
