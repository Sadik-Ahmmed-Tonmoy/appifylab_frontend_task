...
export default function LeftSidebar() {
  return (
    <div className="_layout_left_sidebar_inner">
      ...
      <div className="_left_inner_area_recommend _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area _mar_t16">
        <div className="_left_inner_area_recommend_content _mar_b24">
          <h4 className="_left_inner_area_recommend_title _title5">Suggested People</h4>
          <span className="_left_inner_area_recommend_txt">
            <a className="_recommend_info_link" href="#0">See All</a>
          </span>
        </div>
        ...
        <div className="_left_inner_area_suggest_info">
          <div className="_left_inner_area_suggest_info_box">
            <div className="_left_inner_area_suggest_info_image">
              <a href="profile.html">
                <img src="/assets/images/people3.png" alt="Image" className="_info_img" />
              </a>
            </div>
            <div className="_left_inner_area_suggest_info_txt">
              <a href="profile.html">
      ...
      {/* Events Section */}
      <div className="_left_inner_area_event _padd_t24 _padd_b24 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area _mar_t16">
        <div className="_left_inner_area_event_content _mar_b24">
          <h4 className="_left_inner_area_event_content_title _title5">Events</h4>
          <span className="_left_inner_area_event_content_txt">
            <a className="_recommend_info_link" href="#0">See all</a>
          </span>
        </div>
